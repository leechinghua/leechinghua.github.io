...
// // parameter5 是控制對象的動畫開始時間

// time_line
//   .fromTo(hero, 1, { height: "0%" }, { height: "100%", ease: Power2.easeIOout })
//   .fromTo(
//     hero,
//     1.2,
//     { width: "80%" },
...
addButton.addEventListener("click", () => {
  ...
  newInput3.classList.add("credit");
...
function handleSorting(direction) {
  let graders = document.querySelectorAll("div.graders");
  let objectArray = [];
  ...
  // select修改 重新賦值
  graders = document.querySelectorAll("div.graders");
  for (let i = 0; i < graders.length; i++) {
